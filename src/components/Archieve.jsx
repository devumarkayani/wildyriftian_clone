    ...
    function Archieve() {
      ...
      return (
        <>
        <div className="min-h-screen bg-white text-gray-900   font-serif m-5">
          <div>
            <h3 className="text-3xl pl-11.5">Archive</h3>
            <div className=' lg:pr-[15rem] text-end  ' >
              <h4 className='text-[1rem] text-justify-content-start'>
    ...
    .
          ...
          <section id="works" className="py-20 px-6">
            <div className="container mx-auto  ">
              <div className="grid grid-cols-1 md:grid-cols-8 lg:grid-cols-8 gap-4  border-dotted border   ">
...
//   return (
//     <section id="archive" className="py-20 px-4 bg-white">
//       <motion.h2
...
//         A curated stash of playful, bite-sized creations too small for a project, but too good to keep hidden.
//       </p>
//       <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 max-w-4xl mx-auto">
//         {items.slice(0, 15).map((num) => (
//           <motion.div
//             key={num}
//             initial={{ opacity: 0, scale: 0.8 }}
//             whileInView={{ opacity: 1, scale: 1 }}
//             className="aspect-square bg-gray-200 rounded cursor-pointer hover:bg-gray-300 transition-colors"
//           >
//             <span className="flex items-center justify-center h-full text-sm font-mono">{num.toString().padStart(2, '0')}</span>
//           </motion.div>
//         ))}
//       </div>
//       <motion.div
...
//       >
//         <a href="#" className="text-lg font-semibold text-gray-900 underline">SEE ALL →</a>
//       </motion.div>
//     </section>
//   );
// };
