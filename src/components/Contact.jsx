  ...
  return (
    <section id="contact" className="py-20 px-4 bg-white">
      ...
      <form className="max-w-md mx-auto space-y-4">
        <input type="text" placeholder="Name" className="w-full p-4 border border-gray-300 rounded" />
        <input type="email" placeholder="Email" className="w-full p-4 border border-gray-300 rounded" />
        <textarea placeholder="Message" rows={4} className="w-full p-4 border border-gray-300 rounded" />
        <motion.button
          whileHover={{ scale: 1.05 }}
          type="submit"
          className="w-full p-4 bg-gray-900 text-white rounded font-semibold"
        >
          Send Message
        </motion.button>
      </form>
